...
function TCPopup(field, palette) {
	...
	o_colWindow = window.open('<?php echo '../wp-content/plugins/nba-news-scroll/picker.html'; ?>', null, "help=no,status=no,scrollbars=no,resizable=no" + move + ",width=" + w + ",height=" + h + ",dependent=yes", true);
...
<?php wp_nonce_field('update-options'); ?>
	<input type="Text" name="nbas_scroll_text_color" id="nbas_scroll_text_color" value="<?php echo get_option('nbas_scroll_text_color'); ?>" />
			...
			<a href="javascript:TCP.popup(document.forms['tcp_test'].elements['nbas_scroll_text_color'])"><img width="15" height="13" border="0" alt="Click Here Pick A Color" src="<?php echo '../wp-content/plugins/nba-news-scroll/cpiksel.gif'; ?>" /></a>
      <br />
...
<?php wp_nonce_field('update-options'); ?>
	<input type="Text" name="nbas_scroll_text_color1" id="nbas_scroll_text_color1" value="<?php echo get_option('nbas_scroll_text_color1'); ?>" />
			...
			<a href="javascript:TCP.popup(document.forms['tcp_test1'].elements['nbas_scroll_text_color1'])"><img width="15" height="13" border="0" alt="Click Here Pick A Color" src="<?php echo '../wp-content/plugins/nba-news-scroll/cpiksel.gif'; ?>" /></a>
...
<?php wp_nonce_field('update-options'); ?>
	<input type="Text" name="nbas_scroll_text_color2" id="nbas_scroll_text_color2" value="<?php echo get_option('nbas_scroll_text_color2'); ?>" />
			...
			<a href="javascript:TCP.popup(document.forms['tcp_test2'].elements['nbas_scroll_text_color2'])"><img width="15" height="13" border="0" alt="Click Here Pick A Color" src="<?php echo '../wp-content/plugins/nba-news-scroll/cpiksel.gif'; ?>" /></a>
